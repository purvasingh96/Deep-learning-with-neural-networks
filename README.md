...
This repository contains notes and codes for deep learning from various sources. More specifically this repository aims to provide concise notes on each chapter of *Deep Learning* book. <br>
