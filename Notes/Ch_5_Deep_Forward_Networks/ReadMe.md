...
- [Rectified Linear Unit Activation Function ](#Rectified-Linear-Unit-Activation-Function)
  ...
  * [Linear Model Approach](#linear-model-approach)
    - [Implement single layer neural network via PyTorch](https://github.com/purvasingh96/Deep-learning-with-neural-networks/blob/master/Notes/Ch_5_Deep_Forward_Networks/02.single_layer_neural_network.ipynb)
  * [Non-Linear Model Approach](#non-linear-model-approach)
    - [Implement multi-layer neural network via PyTorch](https://github.com/purvasingh96/Deep-learning-with-neural-networks/blob/master/Notes/Ch_5_Deep_Forward_Networks/03.mutilayer_neural_network.ipynb)
- [Gradient Based Learning](#gradient-based-learning)
  ...
  * [Output Units](#output-units)
    ...
    + [Sigmoid Units for Bernoulli Output Distributions](#sigmoid-units-for-bernoulli-output-distributions) 
      - [Implement Sigmoid via PyTorch](https://github.com/purvasingh96/Deep-learning-with-neural-networks/blob/master/Notes/Ch_5_Deep_Forward_Networks/03.mutilayer_neural_network.ipynb)
    + [Softmax Units for Multinoulli Output Distributions](#softmax-units-for-multinoulli-output-distributions)
      - [Implement Softmax via PyTorch](https://github.com/purvasingh96/Deep-learning-with-neural-networks/blob/master/Notes/Ch_5_Deep_Forward_Networks/04.implementing_softmax.ipynb)
  * [Hidden Units](#hidden-units)
    + [Rectiﬁed Linear Units](#Rectiﬁed-Linear-Units)
      - [Implement ReLU via PyTorch](https://github.com/purvasingh96/Deep-learning-with-neural-networks/blob/master/Notes/Ch_5_Deep_Forward_Networks/05.ReLU_using_pytorch)
...
<img src="./images/45. better_perceptron.png"></img>
...
<img src="./images/53. mount_err_3.png" width="40%" height="40%"></img><br><br>
As the final step, the man reaches the bottom of mount Errorest. This is known as **Gradient Descent.**<br><br>
<img src="./images/54. mount_err_4.png" width="50%" height="50%"></img><br><br>
...
<img src="./images/46. softmax_classifictaion_problem.png"><br>
